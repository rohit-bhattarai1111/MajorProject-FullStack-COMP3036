 ...
 * @description Modern footer with copyright, social links, and contact info
 */
    ...
    <footer className="bg-gray-100 border-t mt-12">
      <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-gray-600 text-center md:text-left">
          <p>&copy; {new Date().getFullYear()} Cricket Store. All rights reserved.</p>
          <p className="text-sm mt-1">Contact: <a href="mailto:info@cricketstore.com" className="text-blue-700 hover:underline">info@cricketstore.com</a></p>
        </div>
        <div className="flex gap-4">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-700 text-2xl" aria-label="Facebook">
          ...
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-pink-600 text-2xl" aria-label="Instagram">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-400 text-2xl" aria-label="Twitter">
